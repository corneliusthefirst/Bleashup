...
export default class EventDetailView extends Component {
  ...
  render() {
    return (
      !this.state.isMounted ? <View style={{ height: height, backgroundColor: '#FEFFDE', width: '100%' }}><Spinner size={'small'}></Spinner></View> :
        <ScrollView showsVerticalScrollIndicator={false} nestedScrolEnabled={true}><View style={{ height: height, width: "100%" }}>
          <View style={{
            height: 44,
            width: "100%",
          }}><View style={{
