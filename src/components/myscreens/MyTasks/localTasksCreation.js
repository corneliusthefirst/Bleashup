...
export default class LocalTasksCreation extends Component {
  ...
  init() {
    stores.Reminds.readFromStore().then((Reminds) => {
      ...
      let remind = find(Reminds, {
        id: this.props.remind_id ? this.props.remind_id : "newRemindId",
      });
      ...
      if (remind.period != "") {
        ...
        this.setState({
          inputDateValue: moment(remind.period).format().split("T")[0],
        });
        this.setState({
          inputTimeValue: moment(remind.period)
            .format()
            .split("T")[1]
            .split("+")[0],
        });
  ...
  handleDatePicked(event, date) {
    if (date !== undefined) {
      ...
      if (this.state.time == "") {
        ...
        this.setState({
          inputDateValue: moment(period).format().split("T")[0],
        });
        let newRemind = {
        ...
        if (!this.props.update) {
          stores.Reminds.updatePeriod(
            this.state.currentRemind.event_id,
            newRemind,
            false
          ).then(() => {});
        }
  ...
  setTime(event, date) {
    if (date !== undefined) {
      ...
      if (this.state.date == "") {
        ...
        this.setState({
          inputTimeValue: moment(period).format().split("T")[1].split("+")[0],
        });
        let newRemind = {
          remind_id: this.state.currentRemind.id,
          period: period,
        ...
        >
          ...
          <ScrollView ref={"scrollView"} showsVerticalScrollIndicator={false}>
            ...
            >
              ...
              <Item
                style={{ borderColor: "black", width: "95%", marginTop: "3%" }}
                rounded
              >
                <Input
                  maxLength={40}
              ...
              >
                ...
                <View>
                  <Input
                    ...
                    value={this.state.inputTimeValue}
                    style={{ color: "#696969" }}
                  />
                </View>
