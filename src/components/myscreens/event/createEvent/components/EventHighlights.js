...
import { StyleSheet, View, Image,TextInput, TouchableOpacity, FlatList, ScrollView, Dimensions } from 'react-native';
          ...
          <View style={{ height: !this.props.event_id ? "95%" : "100%", width: "90%", alignSelf: 'center', }}>
            <ScrollView showsVerticalScrollIndicator={false} ref={"svrollView"} >
              <View style={{ height: "100%" }}>
                ...
                <View style={{ height: height / 10, alignItems: 'center', margin: '2%', }}>
                  {/* <Text style={{alignSelf:'flex-start',margin:"3%",fontWeight:"500",fontSize:16}} >Title :</Text>*/}
                  <Item style={{ borderColor: '1FABAB', width: "100%", margin: '2%',alignItems:"center",height:height/15 }} rounded>
                    <TextInput value={this.state.currentHighlight.title} maxLength={40} placeholder='  highlight title ' keyboardType='email-address' autoCapitalize="none" returnKeyType='next' inverse last
