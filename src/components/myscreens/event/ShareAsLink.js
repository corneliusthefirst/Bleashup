...
import { View, TouchableOpacity, Clipboard, Linking } from 'react-native';
    ...
    modalBody() {
        return <View style={{
            ...
            <View style={{
                ...
                <TouchableOpacity style={this.iconContainerStyle} onPress={this.copy.bind(this)}>
                    <Ionicons style={this.iconStyle} name={"ios-copy"}>
                    </Ionicons>
                </TouchableOpacity>
                <TouchableOpacity onPress={this.openLink.bind(this)} style={this.iconContainerStyle}>
                    <Ionicons style={this.iconStyle} name={"ios-open"}>
                    </Ionicons>
                </TouchableOpacity>
            </View>
            <View style={{
