  ...
  render() {
    return (
      ...
      >
        ...
        <View
          style={{ flexDirection: "row", height: colorList.containerHeight }}
        >
          <View
            style={{
          ...
          >
            ...
            <View style={{ height: 240, alignSelf: "center" }}>
              ...
              >
                <RouteView
                  ...
                  refreshCommitee={() => this.refreshCommitees()}
            ...
            >
              <TouchableOpacity
                ...
                onPress={() => requestAnimationFrame(() => this.onSearch())}
              >
                <View
                  style={{
                    backgroundColor: colorList.bodyBackground,
                ...
                >
                  <EvilIcons
                    style={{ color: colorList.bodyIcon, fontSize: 35 }}
                    name="search"
                  ></EvilIcons>
                </View>
              </TouchableOpacity>
