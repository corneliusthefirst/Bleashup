            ...
            >
                <Content style={{ margin: "10%", flexDirection: 'column', }}>
                    ...
                    <View style={{ alignSelf: 'flex-end', flexDirection: 'row', }}>
                        <Button onPress={() => this.props.closed()} style={{ width: 100, marginRight: 60, alignItems: 'center', }}><Text>Cancel</Text></Button>
                        <Button onPress={() => this.props.callback()} style={{ width: 100, alignItems: 'center', }} danger><Text>{this.props.ok ? this.props.ok : "Leave"}</Text></Button>
                    </View>
                </Content>
            </Modal>
        );
