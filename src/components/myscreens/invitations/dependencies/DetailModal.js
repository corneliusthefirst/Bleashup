        ...
        return this.state.details ? (
            <Modal
                ...
                style={{
                    ...
                    height: "97%", borderRadius: 15, backgroundColor: '#FEFFDE', width: "95%"
                }}
                position={'center'}
            >
                <View>
                ...
                <TouchableOpacity onPress={() => {this.props.onClosed}
                    ...
                    <CacheImages thumbnails source={{ uri: this.state.profile.image }} square style={{ marginTop: 20,width:330, height:"80%" }} />
                </TouchableOpacity>

                {this.state.profile.status.length > 35 ? <Text style={{ fontSize: 17, fontWeight: '600', marginLeft: 14, marginTop:-80  }} note>
                    {this.state.profile.status}</Text> :
                    <Text style={{ fontSize: 17, fontWeight: '600', marginLeft: -104, marginTop:-80 }} note>{this.state.profile.status}</Text>}
            
              {this.props.accept||this.props.deny ?  <View style={{}}><Text style={{}} note></Text></View> : 
            
               <View style={{flexDirection:'row',justifyContent:'space-between',marginTop:15}}>
               <Button onPress={this.props.onAccept}  style ={{marginRight:50,width:"25%"}} success ><Text style={{marginLeft:22}}>Accept</Text></Button>
               <Button onPress={this.props.onDenied}  style ={{marginLeft:50,width:"25%"}} danger ><Text style={{marginLeft:22}}>Delete</Text></Button>
                </View>
