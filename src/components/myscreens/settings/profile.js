...
@observer class ProfileView extends BeComponent {
  constructor(props) {
    super(props);
    this.state = {
      isMount: false,
        ...
        <View style={{ height: 300, width: "100%", justifyContent: "center", alignItems: "center" }}>
          ...
          <TouchableWithoutFeedback>
            <View style={{
              ...
              position: 'absolute',
              right: width / 6, bottom: 40
            }}>
              <PickersUpload fontSize={35}
                notVideo
                ...
                onlyPhotos
                currentURL={this.state.url}></PickersUpload>
            </View>
          </TouchableWithoutFeedback>
        </View>
    ...
    return (
      <View style={{ height: 300, width: "85%", justifyContent: "center", alignItems: "center", flexDirection: 'column' }}>
        ...
        <View style={{ width: "100%", justifyContent: "center", height: height / 8, flexDirection: "row", marginTop: 15 }}>
          ...
          <TouchableOpacity onPress={this.updateName.bind(this)} style={{ width: "10%" }}>
        ...
        <View style={{ height: ColorList.headerHeight }}>
          <View style={{
            ...
            <View style={{ flex: 1, flexDirection: "row", width: width / 3, marginLeft: width / 25, justifyContent: "space-between", alignItems: "center" }}>
              ...
              <Text style={{ ...GState.defaultTextStyle, fontSize: 18, fontWeight: "bold", marginRight: "16%" }}>Profile</Text>
            </View>
          </View>
        </View>
