...
export default class PhotoUploader extends BePureComponent {
    ...
    render() {
        return (
            <View
                style={{ width: this.messageWidth, minWidth: GState.messageMediaWidth }}
            >
                <View>
                    <View>
                        <TouchableOpacity
                        ...
                        {this.state.loaded ? (
                            <View style={{ marginTop: 0 }}>
                                <View>
                                    ...
                                    >
                                        {this.toMB(this.state.total).toFixed(1)} {"Mb"}
                                    </Text>
                                </View>
                            </View>
                        ) : (
                                <View style={{ marginTop: 1 }}>
                                            ...
                                            {(fill) => (
                                                <View>
                                                    {this.state.uploading ? (
                                                        <TouchableWithoutFeedback
                                                            onPress={() =>
                                                                this.cancelUpLoad(this.props.message.source)
                                                            }
                                                        >
                                                            <View>
                                                                <EvilIcons
                                    ...
                                    >
                                        <Text style={{ color: ColorList.bodyBackground }} note>
                                            {"("}
