...
export default class DateView extends Component {
    ...
    render() {
        return (
            <View style={{ width: 150, height: 30, backgroundColor: this.props.backgroundColor ? this.props.backgroundColor : "#fff", borderRadius: 10, alignSelf: 'center', borderWidth: 1,
