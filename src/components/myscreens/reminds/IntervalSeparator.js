...
export default class IntervalSeparator extends Component {
    ...
    render() {
        return <View style={{ margin: '4%',opacity:.7, backgroundColor: this.props.actualInterval ? ColorList.indicatorColor : ColorList.indicatorColor, borderRadius: 5, ...shadower(4), height: 40 }}>
