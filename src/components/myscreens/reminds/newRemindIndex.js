    ...
    render() {
        ...
        return !this.state.mounted ? null : (
            ...
            <View style={{ flex: 1, backgroundColor: '#FEFFDE' }}>
                ...
                <TasksCreation event_id={this.props.event_id} isOpen={this.state.RemindCreationState} onClosed={() => { this.setState({ RemindCreationState: false }) }} parentComp={this} eventRemindData={this.state.eventRemindData}></TasksCreation>
