...
import Profile from "./myscreens/profile/index";
import Settings from "./myscreens/settings/index";
import ReceivedEvents from "./myscreens/receivedevents/index";
import SendEvents from "./myscreens/sendevents/index";
...
*/
import SideBar from "./myscreens/sidebar/index";
/*
...
*/
//screens imported are given to their drawer defined routes
const Drawer = createDrawerNavigator(
  {
    Home: { screen: Home },
    Profile: { screen: Profile },
    SendEvents: { screen: SendEvents },
    ReceivedEvents: { screen: ReceivedEvents },
    Trash: { screen: Trash },
